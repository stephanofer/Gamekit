...
tasks.register("publishGameKitLibrariesToMavenLocal") {
    ...
    dependsOn(
        ...
        ":gamekit-experience:publishToMavenLocal",
        ":gamekit-progression:publishToMavenLocal",
        ":gamekit-season:publishToMavenLocal",
        ...
        ":gamekit-scoreboard-paper:publishToMavenLocal",
        ":gamekit-zmenu-paper:publishToMavenLocal",
        ":gamekit-cloud-paper:publishToMavenLocal",
        ":gamekit-velocity:publishToMavenLocal",
        ":gamekit-paper-worldedit:publishToMavenLocal",
